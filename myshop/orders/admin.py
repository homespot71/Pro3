...
"""
Это функция, которая принимает объект Order в качестве аргумента и воз-
вращает HTML-ссылку на URL-адрес admin_order_detail. По умолчанию Django
экранирует HTML-результат, и во избежание автоматического экранирова-
ния необходимо использовать функцию mark_safe."""
...
response
Динамически извлекаются поля модели, используя метод get_fields()
